...
layout: distill
title: Jang Suhyeok
description: Personal blog for AI810 project.
date: 2024-05-07
future: true
htmlwidgets: true
hidden: true
...
Below, we generate a few examples of such diagrams using languages such as [plantuml](https://plantuml.com/){:target="\_blank"}, [vega-lite](https://vega.github.io/vega-lite/){:target="\_blank"}, etc.
